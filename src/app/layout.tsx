...
export const metadata: Metadata = {
  title: "Grand Luxe Hotel | 5-Star Luxury Accommodations",
  description: "Experience unparalleled luxury at Grand Luxe Hotel. Premium suites, world-class amenities, fine dining, and exceptional service await you.",
  keywords: "luxury hotel, 5-star accommodation, premium suites, spa wellness, fine dining, luxury travel",
  openGraph: {
    title: "Grand Luxe Hotel | 5-Star Luxury Accommodations",
    description: "Experience unparalleled luxury at Grand Luxe Hotel. Premium suites, world-class amenities, fine dining, and exceptional service await you.",
    ...
    images: [{
      ...
      alt: "Grand Luxe Hotel luxury lobby"
    }]
  },
  twitter: {
